...
public class TicketsJson {
    ...
    public String toString() {
        return "TicketsJson [actionCount=" + actionCount + ", actions=" + actions + ", baseStatus=" + baseStatus
                + ", category=" + category + ", chatTalkTime=" + chatTalkTime + ", chatWaitingTime=" + chatWaitingTime
                + ", closedIn=" + closedIn + ", createdDate=" + createdDate + ", dataTicket=" + dataTicket
                + ", horaTicket=" + horaTicket + ", id=" + id + ", justification=" + justification + ", lastActionDate="
                + lastActionDate + ", lastUpdate=" + lastUpdate + ", lifeTimeWorkingTime=" + lifeTimeWorkingTime
                + ", origin=" + origin + ", originEmailAccount=" + originEmailAccount + ", owner=" + owner
                + ", ownerTeam=" + ownerTeam + ", protocol=" + protocol + ", reopenedIn=" + reopenedIn + ", resolvedIn="
                + resolvedIn + ", resolvedInFirstCall=" + resolvedInFirstCall + ", slaAgreement=" + slaAgreement
